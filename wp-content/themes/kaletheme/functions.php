...
function kaletheme_scripts() {
	...
	wp_enqueue_style( 'kaletheme-animate', get_template_directory_uri() . '/animate.css' );
	wp_enqueue_script( 'kaletheme-jscrips', get_template_directory_uri() . '/js/jQueryScripts.js', array('jquery'), '20151215', true );
	...
	wp_enqueue_script( 'kaletheme-google', '//maps.googleapis.com/maps/api/js');
	wp_enqueue_script( 'kaletheme-wow', get_template_directory_uri() . '/js/wow.js', array(), '20151215', true );
