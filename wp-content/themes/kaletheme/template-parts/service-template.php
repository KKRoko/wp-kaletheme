...
<?php get_header(); ?>
  ...
  <div class="srv-body-wrapper">
    ...
    <section>
      <div class="srv-cont">
        <div class="srv-card">
            <div class="card-img-cont-right">
              <img class="alignnone size-full wp-image-93" src="/wp-content/uploads/2017/02/creative.svg" alt="" />
            </div>
        ...
        <div class="srv-card">
            ...
            <div class="card-img-cont-left">
              <img class="alignnone size-full wp-image-93" src="/wp-content/uploads/2017/02/coding.svg" alt="" />
            </div>
        </div>
        <div class="srv-card">
            <div class="card-img-cont-right">
              <img class="alignnone size-full wp-image-93" src="/wp-content/uploads/2017/02/brainstorm.svg" alt="" />
            </div>
            <div class="card-content-cont-right">
              <h4>Strategy</h4>
              <p>
        ...
        <div class="srv-card">
            ...
            <div class="card-img-cont-left">
              <img class="alignnone size-full wp-image-93" src="/wp-content/uploads/2017/02/email.svg" alt="" />
            </div>
        </div>
      </div>
    </section>
          ...
          <div class="tls-srvs-card">
            ...
            <div class="tls-srvs-list">
              <ul>
                ...
                <li>Convert Design into pixel perfect HTML</li>
                <li>Wireframes</li>
                <li>Prototypes</li>
                <li>W3C Validation for SEO</li>
                <li>Work related to JavaScript / jQuery</li>
              </ul>
            </div>
            <div class="tls-srvs-imgs">
              <img class="crt-icon" src="/wp-content/uploads/2017/02/devices.svg" alt="" />
              <img class="crt-icon" src="/wp-content/uploads/2017/02/map.svg" alt="" />
              <img class="crt-icon" src="/wp-content/uploads/2017/02/responsive.svg" alt="" />
              <img class="crt-icon" src="/wp-content/uploads/2017/02/html.svg" alt="" />
              <img class="crt-icon" src="/wp-content/uploads/2017/02/css.svg" alt="" />
              <img class="crt-icon" src="/wp-content/uploads/2017/02/javascript.svg" alt="" />
              <img class="crt-icon" src="/wp-content/uploads/2017/02/sketch.svg" alt="" />
            </div>
          </div>
          <div class="tls-srvs-card">
            <h6>Single / Multi Page Application</h6>
            <div class="tls-srvs-list">
              <ul>
                <li>ES6 / Babel</li>
                <li>HTML5 / CSS3</li>
            ...
            <div class="tls-srvs-imgs">
              <img class="crt-icon" src="/wp-content/uploads/2017/02/react.svg" alt="" />
              <img class="crt-icon-x" src="/wp-content/uploads/2017/02/nodejs.svg" alt="" />
              <img class="crt-icon" src="/wp-content/uploads/2017/02/wordpress-blue.svg" alt="" />
              <img class="crt-icon" src="/wp-content/uploads/2017/02/woocommerce.svg" alt="" />
            </div>
          </div>
          <div class="tls-srvs-card">
            <h6>E-Commerce</h6>
