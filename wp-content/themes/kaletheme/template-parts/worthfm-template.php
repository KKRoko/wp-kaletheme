        ...
        <div class="work-worthfm-body-container">
          <div class="work-worthfm-body-description-container" >
            <div  class="work-worthfm-description wow fadeInUp data-wow-duration="1s" data-wow-delay=".4s"">
              <p>WorthFM is a savings and investment platform
                designed for women. The platform provides automated and personalized
                advice across savings, investing, and retirement accounts based on a
                person’s unique "financial personality", situation, knowledge level
                and lifestyle. They believe that to be a successful investor, you
                 shouldn’t have to understand fund selection, financial jargon, or
            ...
            <div class="work-worthfm-body-description-goal wow fadeInUp data-wow-duration="1s" data-wow-delay=".4s"">
              <h4>The Goal</h4>
              <p>The company wanted to create a new design to increase web traffic and conversion.The goal was to get our clients to sign up from the email marketing
                campaigns we were pursuing. We wanted people to find out who we are and what we stand for.</p>
            </div>
            ...
            <div class="work-worthfm-link wow bounceIn data-wow-duration=".6s" data-wow-delay="1s"">
              <a href="https://www.worthfm.com/" target="_blank">Visit Website</a>
            </div>
          </div>
