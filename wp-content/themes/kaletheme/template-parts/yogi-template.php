...
<div class="yogi-wrapper">
  <section>
    <div class="yogi-header-container">
      <div class="yogi-header-cover">
        <div class="work-yogi-title">
          <span>Yogi</span>
        </div>
      </div>
    </div>
      ...
      <div class="yogi-body-description-container">
        ...
        <div class="work-yogi-body-description-process wow fadeInUp data-wow-duration="1s" data-wow-delay=".4s"">
          ...
          <p>
            ...
            site using Wordpress was the best solution. Wordpress is one of the best CMS
            frameworks for small business and for owners who have little knowledge
            in web development but want to maintain their own web site. I created
